...
//AVATAR�
   ...
   client.channels.get("442303347731595275").sendFile(canvas.toBuffer())
  client.channels.get("442303347731595275").send(`Welcome ${member} To __${member.guild.name}__`)
   })})  }
   });
